...
class RestaurantProfileController extends Controller
{
    ...
    public function showStep1() {
        ...
        return view('crear-perfil.restaurante'); 
    }
    ...
    public function saveStep1(Request $request) {
        ...
        if ($request->hasFile('imagen-perfil')) {
            ...
            $datos['imagen_perfil_path'] = $path;
        }

        if ($request->hasFile('imagen-portada')) {
            $path = $request->file('imagen-portada')->store('temp/covers', 'public');
            $datos['imagen_portada_path'] = $path;
        }

        Session::put('restaurant_step1', $datos);
    ...
    public function showStep2() {
        ...
        return view('crear-perfil.restaurante-2');
    }
