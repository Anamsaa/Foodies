<div class="evento-card">
    ...
    <div class="evento-imagen">
        <img src="{{ optional($evento->restaurant->profile->profilePhoto)->url ?? asset('images/default_image_profile.png') }}" alt="Foto del restaurante">
    </div>
    <div class="evento-detalles">
        ...
        <p><strong>Locación:</strong> {{ $evento->restaurant->name }}</p>
