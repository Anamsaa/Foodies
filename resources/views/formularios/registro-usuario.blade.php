@extends('layouts.formulario.background-formulario')
    ...
    <div class="contenedor-registro-usuario">
        ...
        <form action="">
            <div class="contenedor-formulario">
                ...
                <input type="text" id="nombre" name="nombre" placeholder="Julian" required>
            </div>
            <div class="contenedor-formulario">
                <label for="apellidos">Apellidos: </label>
                <input type="text" id="apellidos" name="apellidos" placeholder="Moreno" required>
            </div>
            <div class="contenedor-formulario">
